...
from keras.layers import Dense, GRU, TimeDistributed, Lambda, Input
...
def build_RNN_im_VGG(model_path, printable):
    ...
    x = GRU(64, name = 'gru_10', return_sequences=False)(ix)
#    x = Dropout(0.1)(x)
...
weights = '/app/Experiment1_GRU/weights.000002-0.928-0.190-0.402-2.905.h5'

...
from build_prop_model import build_model_prop_3t
...
for tasks in [['age', 'gender', 'ethnicity']]:
    ...
    for i in range(3):
        ...
        if i == 0 or (sum(current_acc) > np.array(acc).sum(axis=1)).all():
            ...
            model.save('baseline_{}{}{}.h5'.format(tasks[0], tasks[1], tasks[2]))
        ...
        with open("history{}{}{}{}Baseline.pkl".format(i, tasks[0], tasks[1], tasks[2]), "wb") as handle:
            pickle.dump(history.history, handle)

    with open("weights_baseline{}{}{}.pkl".format(tasks[0], tasks[1], tasks[2]), "wb") as handle:
...
for tasks in [['age', 'gender', 'ethnicity']]:
    ...
    weights = pickle.load(open("weights_baseline{}{}{}.pkl".format(tasks[0], tasks[1], tasks[2]), "rb"))
    ...
    for nb_prop_layers in range(1,6):
        ...
        for i in range(3):
            ...
            if i == 0 or (sum(current_acc) > np.array(acc).sum(axis=1)).all():
                ...
                model.save('prop{}_{}{}{}.h5'.format(nb_prop_layers, tasks[0], tasks[1], tasks[2]))
            ...
            with open("history{}{}{}{}{}PropAdd.pkl".format(i, tasks[0], tasks[1], tasks[2], nb_prop_layers), "wb") as handle:
                pickle.dump(history.history, handle)

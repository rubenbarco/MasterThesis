...
from build_hard_param import hard_param_model_3t
...
for tasks in [['age', 'gender', 'ethnicity']]:
    for nb_shared_blocks in range(1,6):
        ...
        for i in range(3):
            ...
            if i == 0:
                model.save('hardparam{}{}{}{}.h5'.format(nb_shared_blocks, tasks[0], tasks[1],tasks[2]))
            ...
            with open("history_hardparam{}{}{}{}{}.pkl".format(tasks[0], tasks[1], tasks[2], nb_shared_blocks, i), "wb") as handle:
